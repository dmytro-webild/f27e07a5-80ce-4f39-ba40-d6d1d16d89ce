...
export default function LandingPage() {
  ...
  <div id="about" data-section="about">
      ...
      description={[
        "At ShopCommerce, we believe in providing products that blend form and function seamlessly.",
        "Our team hand-picks every item to ensure excellence in quality, aesthetics, and utility.",
        "We prioritize sustainability and modern craftsmanship in every partnership we make.",
      ]}
    />
  </div>
  ...
  <div id="features" data-section="features">
      ...
      features={[
        {
          title: "Free Shipping",
          description: "Free delivery on all orders over $50 across the country.",
          imageSrc: "http://img.b2bpic.net/free-photo/modern-gym-composition-with-sport-elements_23-2147913642.jpg",
          imageAlt: "Shipping",
        },
        {
          title: "24/7 Support",
          description: "Our support team is always available to help with any inquiries.",
          imageSrc: "http://img.b2bpic.net/free-photo/still-life-minimalist-lifestyle_23-2149743895.jpg",
          imageAlt: "Support",
        },
        {
          title: "Easy Returns",
          description: "100% satisfaction guaranteed with our hassle-free return policy.",
          imageSrc: "http://img.b2bpic.net/free-photo/colorful-ffp2-masks-shopping-carts-arrangement_23-2149366751.jpg",
          imageAlt: "Returns",
        },
      ]}
      title="Why Choose Us?"
  ...
  <div id="products" data-section="products">
      ...
      products={[
        ...
        },
        {
          ...
          price: "$120",
          variant: "Luxury",
          imageSrc: "http://img.b2bpic.net/free-photo/blossoms-colorful-backdrops_23-2151916651.jpg",
        },
        {
          id: "p3",
          ...
          price: "$45",
          variant: "Home",
          imageSrc: "http://img.b2bpic.net/free-photo/close-up-eucalyptus-plant_23-2149200302.jpg",
        },
        {
          id: "p4",
          ...
          price: "$75",
          variant: "Active",
          imageSrc: "http://img.b2bpic.net/free-photo/elegant-plants-decoration-vase_23-2149334649.jpg",
        },
        {
          id: "p5",
          name: "Wireless Audio Hub",
          price: "$199",
          variant: "Tech",
        ...
        },
        {
          ...
          price: "$60",
          variant: "Home",
          imageSrc: "http://img.b2bpic.net/free-photo/sphere-representing-iris-eye_23-2151642923.jpg",
        },
      ]}
  ...
  <div id="faq" data-section="faq">
      ...
      faqs={[
        ...
        },
        {
          ...
          content: "Once your order ships, we'll send you an email with a tracking number.",
        },
        {
          id: "f3",
          title: "Do you offer international shipping?",
          content: "Currently, we only ship domestically, but we are expanding to new regions.",
        },
      ]}
